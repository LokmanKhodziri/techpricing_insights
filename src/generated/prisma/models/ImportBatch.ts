...
export type ImportBatchWhereInput = {
  ...
  fileFormat?: Prisma.StringFilter<"ImportBatch"> | string
  platform?: Prisma.EnumMarketplacePlatformNullableFilter<"ImportBatch"> | $Enums.MarketplacePlatform | null
...
export type ImportBatchScalarWhereWithAggregatesInput = {
  ...
  fileFormat?: Prisma.StringWithAggregatesFilter<"ImportBatch"> | string
  platform?: Prisma.EnumMarketplacePlatformNullableWithAggregatesFilter<"ImportBatch"> | $Enums.MarketplacePlatform | null
...
export type ImportBatchCreateInput = {
  ...
  successCount?: number
  errorCount?: number
  errors?: runtime.InputJsonValue | null
...
export type ImportBatchUpdateInput = {
  ...
  platform?: Prisma.NullableEnumMarketplacePlatformFieldUpdateOperationsInput | $Enums.MarketplacePlatform | null
  ...
  errors?: runtime.InputJsonValue | runtime.InputJsonValue | null
...
export type NullableEnumMarketplacePlatformFieldUpdateOperationsInput = {
  set?: $Enums.MarketplacePlatform | null
  unset?: boolean
}
...
export type ImportBatchOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "fileName" | "fileFormat" | "platform" | "rowCount" | "successCount" | "errorCount" | "errors" | "importedAt", ExtArgs["result"]["importBatch"]>
...
export interface ImportBatchDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  ...
  /**
   * Find zero or more ImportBatches that matches the filter.
   * @param {ImportBatchFindRawArgs} args - Select which filters you would like to apply.
   * @example
   * const importBatch = await prisma.importBatch.findRaw({
   *   filter: { age: { $gt: 25 } }
   * })
   */
  findRaw(args?: Prisma.ImportBatchFindRawArgs): Prisma.PrismaPromise<Prisma.JsonObject>

  /**
   * Perform aggregation operations on a ImportBatch.
   * @param {ImportBatchAggregateRawArgs} args - Select which aggregations you would like to apply.
   * @example
   * const importBatch = await prisma.importBatch.aggregateRaw({
   *   pipeline: [
   ...
   * })
   */
  aggregateRaw(args?: Prisma.ImportBatchAggregateRawArgs): Prisma.PrismaPromise<Prisma.JsonObject>
...
export interface ImportBatchFieldRefs {
  ...
  readonly fileFormat: Prisma.FieldRef<"ImportBatch", 'String'>
  readonly platform: Prisma.FieldRef<"ImportBatch", 'MarketplacePlatform'>
 ...
 * ImportBatch findRaw
 */
export type ImportBatchFindRawArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  /**
...
/**
 * ImportBatch aggregateRaw
 */
export type ImportBatchAggregateRawArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  /**
